...
; 2) garbage-cans: garabage can agent.
...
vacuums-own [beliefs desire intention dirt_count]
...
to update-desires
  ...
  ask vacuums [
    ...
    if dirt_count = bag_capacity [ set desire "dump"]
  ]
end
...
to update-intentions
  ...
  ask vacuums [
    ifelse desire = "clean" [
      ...
      ifelse desire = "dump" [
        let x [xcor] of one-of garbage-cans ; there is only one anyways
